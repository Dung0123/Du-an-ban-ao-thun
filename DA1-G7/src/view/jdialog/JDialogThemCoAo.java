 ...
 * @author cuongwf
 */
public class JDialogThemCoAo extends javax.swing.JDialog {

    private final IThuocTinhService<CoAo> coAoService = new CoAoService();

    public JDialogThemCoAo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        coAoService.getAll();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogThemCoAo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogThemCoAo dialog = new JDialogThemCoAo(new javax.swing.JFrame(), true);
